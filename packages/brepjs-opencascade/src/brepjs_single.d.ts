...
export declare class TDF_Label {
  ...
  Transaction(): Standard_Integer;
  /** Returns true if node address of <me> is lower than <otherLabel> one. Used to quickly sort labels (not on entry criterion). -C++: inline */
  HasLowerNode(otherLabel: TDF_Label): Standard_Boolean;
  /** Returns true if node address of <me> is greater than <otherLabel> one. Used to quickly sort labels (not on entry criterion). -C++: inline */
...
export declare class STEPCAFControl_Reader {
  ...
  /** Loads a file and returns the read status Provided for use like single-file reader. theFileName file to open read status */
  ...
  /** Returns flags defining operations to be performed on shapes. Pair of values defining operations to be performed on shapes and a boolean value that indicates whether the flags were set. */
...
export declare class STEPCAFControl_Writer {
  ...
  /** Set clean duplicates flag. If set to True, duplicates will be removed from the model. theCleanDuplicates the flag to set. */
  SetCleanDuplicates(theCleanDuplicates: Standard_Boolean): void;
  /** Returns the flag indicating whether duplicates should be removed from the model. the flag indicating whether duplicates should be removed from the model. */
...
export declare type STEPControl_StepModelType = {
  STEPControl_AsIs: STEPControl_StepModelTypeValue;
  STEPControl_ManifoldSolidBrep: STEPControl_StepModelTypeValue;
  STEPControl_BrepWithVoids: STEPControl_StepModelTypeValue;
  STEPControl_FacetedBrep: STEPControl_StepModelTypeValue;
  STEPControl_FacetedBrepAndBrepWithVoids: STEPControl_StepModelTypeValue;
  STEPControl_ShellBasedSurfaceModel: STEPControl_StepModelTypeValue;
  STEPControl_GeometricCurveSet: STEPControl_StepModelTypeValue;
  STEPControl_Hybrid: STEPControl_StepModelTypeValue;
}

export declare type STEPControl_StepModelTypeValue = 'STEPControl_AsIs' | 'STEPControl_ManifoldSolidBrep' | 'STEPControl_BrepWithVoids' | 'STEPControl_FacetedBrep' | 'STEPControl_FacetedBrepAndBrepWithVoids' | 'STEPControl_ShellBasedSurfaceModel' | 'STEPControl_GeometricCurveSet' | 'STEPControl_Hybrid';
...
export declare class StlAPI_Reader {
  constructor();
  /** Reads STL file to the TopoDS_Shape (each triangle is converted to the face). True if reading is successful */
...
export declare class StlAPI_Writer {
  ...
  /** Converts a given shape to STL format and writes it to file with a given filename. the error state. */
...
export declare type XCAFDoc_ColorType = {
  XCAFDoc_ColorGen: XCAFDoc_ColorTypeValue;
  XCAFDoc_ColorSurf: XCAFDoc_ColorTypeValue;
  XCAFDoc_ColorCurv: XCAFDoc_ColorTypeValue;
}
...
export declare class XCAFDoc_LengthUnit extends TDF_Attribute {
  ...
  static GetID(): Standard_GUID;
  /** Finds or creates a LengthUnit attribute theUnitName - name of the unit: mm, m, cm, km, micron, in, min, nin, ft, stat.mile theUnitValue - length scale factor to meter The LengthUnit attribute is returned. */
...
export declare class XCAFDoc_ShapeTool extends TDataStd_GenericEmpty {
  ...
  /** Gets shape from a sequence of shape's labels theLabels a sequence of labels to get shapes from original shape in case of one label and a compound of shapes in case of more */
  ...
  /** Sets location to the shape label If label is reference -> changes location attribute If label is free shape -> creates reference with location to it theShapeLabel the shape label to change location theLoc location to set theRefLabel the reference label with new location TRUE if new location was set */
  ...
  /** Method to get NamedData attribute assigned to the given shape label. theLabel the shape Label theToCreate create and assign attribute if it doesn't exist Handle to the NamedData attribute or Null if there is none */
...
export declare type IFSelect_ReturnStatus = {
  IFSelect_RetVoid: IFSelect_ReturnStatusValue;
  IFSelect_RetDone: IFSelect_ReturnStatusValue;
  IFSelect_RetError: IFSelect_ReturnStatusValue;
  IFSelect_RetFail: IFSelect_ReturnStatusValue;
  IFSelect_RetStop: IFSelect_ReturnStatusValue;
}

export declare type IFSelect_ReturnStatusValue = 'IFSelect_RetVoid' | 'IFSelect_RetDone' | 'IFSelect_RetError' | 'IFSelect_RetFail' | 'IFSelect_RetStop';
...
export declare class IFSelect_WorkSession extends Standard_Transient {
  ...
  /** Following the type of : Dispatch : Adds or Removes it in the ShareOut & FileNaming GeneralModifier : Adds or Removes it for final sending (i.e. in the ModelCopier) Returns True if it did something, False else (state unchanged) */
  ...
  /** Sets a GeneralModifier to be applied to an item : item = ShareOut : applies for final sending (all dispatches) item is a Dispatch : applies for this dispatch only Returns True if done, False if <modif> or not in <me> */
...
export declare class MoniTool_TypedValue extends Standard_Transient {
  ...
  IntegerLimit(max: Standard_Boolean): { result: Standard_Boolean; val: number };
  ...
  RealLimit(max: Standard_Boolean): { result: Standard_Boolean; val: number };
  ...
  EnumDef(): { result: Standard_Boolean; startcase: number; endcase: number; match: boolean };
...
export declare class XSControl_Reader {
  ...
  GetStatsTransfer(list: any): { nbMapped: number; nbWithResult: number; nbWithFail: number };
  /** Returns flags defining operations to be performed on shapes. Pair of values defining operations to be performed on shapes and a boolean value that indicates whether the flags were set. */
  GetShapeProcessFlags(): any;
  delete(): void;
  [Symbol.dispose](): void;
...
export declare class Bnd_OBB {
  ...
  /** Returns the local coordinates system of this oriented box. So that applying it to axis-aligned box ((-XHSize, -YHSize, -ZHSize), (XHSize, YHSize, ZHSize)) will produce this oriented box. gp_TrsfaLoc; aLoc.SetTransformation(theOBB.Position(),gp::XOY()); */
  Position(): gp_Ax3;
  ...
  /** Returns the half-size dimensions of the OBB as a HalfSizes structure. Can be used with C++17 structured bindings: auto[aHX,aHY,aHZ]=anOBB.GetHalfSizes(); */
...
export declare type Convert_ParameterisationType = {
  Convert_TgtThetaOver2: Convert_ParameterisationTypeValue;
  Convert_TgtThetaOver2_1: Convert_ParameterisationTypeValue;
  Convert_TgtThetaOver2_2: Convert_ParameterisationTypeValue;
  Convert_TgtThetaOver2_3: Convert_ParameterisationTypeValue;
  Convert_TgtThetaOver2_4: Convert_ParameterisationTypeValue;
  Convert_QuasiAngular: Convert_ParameterisationTypeValue;
  Convert_RationalC1: Convert_ParameterisationTypeValue;
  Convert_Polynomial: Convert_ParameterisationTypeValue;
}

export declare type Convert_ParameterisationTypeValue = 'Convert_TgtThetaOver2' | 'Convert_TgtThetaOver2_1' | 'Convert_TgtThetaOver2_2' | 'Convert_TgtThetaOver2_3' | 'Convert_TgtThetaOver2_4' | 'Convert_QuasiAngular' | 'Convert_RationalC1' | 'Convert_Polynomial';

export declare type GeomAbs_CurveType = {
  GeomAbs_Line: GeomAbs_CurveTypeValue;
  GeomAbs_Circle: GeomAbs_CurveTypeValue;
  GeomAbs_Ellipse: GeomAbs_CurveTypeValue;
  GeomAbs_Hyperbola: GeomAbs_CurveTypeValue;
  GeomAbs_Parabola: GeomAbs_CurveTypeValue;
  GeomAbs_BezierCurve: GeomAbs_CurveTypeValue;
  GeomAbs_BSplineCurve: GeomAbs_CurveTypeValue;
  GeomAbs_OffsetCurve: GeomAbs_CurveTypeValue;
  GeomAbs_OtherCurve: GeomAbs_CurveTypeValue;
}

export declare type GeomAbs_CurveTypeValue = 'GeomAbs_Line' | 'GeomAbs_Circle' | 'GeomAbs_Ellipse' | 'GeomAbs_Hyperbola' | 'GeomAbs_Parabola' | 'GeomAbs_BezierCurve' | 'GeomAbs_BSplineCurve' | 'GeomAbs_OffsetCurve' | 'GeomAbs_OtherCurve';

export declare type GeomAbs_JoinType = {
  GeomAbs_Arc: GeomAbs_JoinTypeValue;
  GeomAbs_Tangent: GeomAbs_JoinTypeValue;
  GeomAbs_Intersection: GeomAbs_JoinTypeValue;
}

export declare type GeomAbs_JoinTypeValue = 'GeomAbs_Arc' | 'GeomAbs_Tangent' | 'GeomAbs_Intersection';

export declare type GeomAbs_Shape = {
  GeomAbs_C0: GeomAbs_ShapeValue;
  GeomAbs_G1: GeomAbs_ShapeValue;
  GeomAbs_C1: GeomAbs_ShapeValue;
  GeomAbs_G2: GeomAbs_ShapeValue;
  GeomAbs_C2: GeomAbs_ShapeValue;
  GeomAbs_C3: GeomAbs_ShapeValue;
  GeomAbs_CN: GeomAbs_ShapeValue;
}

export declare type GeomAbs_ShapeValue = 'GeomAbs_C0' | 'GeomAbs_G1' | 'GeomAbs_C1' | 'GeomAbs_G2' | 'GeomAbs_C2' | 'GeomAbs_C3' | 'GeomAbs_CN';

export declare type GeomAbs_SurfaceType = {
  GeomAbs_Plane: GeomAbs_SurfaceTypeValue;
  GeomAbs_Cylinder: GeomAbs_SurfaceTypeValue;
  GeomAbs_Cone: GeomAbs_SurfaceTypeValue;
  GeomAbs_Sphere: GeomAbs_SurfaceTypeValue;
  GeomAbs_Torus: GeomAbs_SurfaceTypeValue;
  GeomAbs_BezierSurface: GeomAbs_SurfaceTypeValue;
  GeomAbs_BSplineSurface: GeomAbs_SurfaceTypeValue;
  GeomAbs_SurfaceOfRevolution: GeomAbs_SurfaceTypeValue;
  GeomAbs_SurfaceOfExtrusion: GeomAbs_SurfaceTypeValue;
  GeomAbs_OffsetSurface: GeomAbs_SurfaceTypeValue;
  GeomAbs_OtherSurface: GeomAbs_SurfaceTypeValue;
}

export declare type GeomAbs_SurfaceTypeValue = 'GeomAbs_Plane' | 'GeomAbs_Cylinder' | 'GeomAbs_Cone' | 'GeomAbs_Sphere' | 'GeomAbs_Torus' | 'GeomAbs_BezierSurface' | 'GeomAbs_BSplineSurface' | 'GeomAbs_SurfaceOfRevolution' | 'GeomAbs_SurfaceOfExtrusion' | 'GeomAbs_OffsetSurface' | 'GeomAbs_OtherSurface';
...
export declare class Poly_Connect {
  ...
  Triangles(T: Standard_Integer): { t1: number; t2: number; t3: number };
  ...
  Nodes(T: Standard_Integer): { n1: number; n2: number; n3: number };
...
export declare class Poly_Triangulation extends Standard_Transient {
  ...
  /** Returns a node at the given index. theIndex node index within [1, NbNodes()] range 3D point coordinates */
  Node(theIndex: Standard_Integer): gp_Pnt;
  /** Sets a node coordinates. theIndex node index within [1, NbNodes()] range thePnt 3D point coordinates */
  SetNode(theIndex: Standard_Integer, thePnt: gp_Pnt): void;
  /** Returns UV-node at the given index. theIndex node index within [1, NbNodes()] range 2D point defining UV coordinates */
  UVNode(theIndex: Standard_Integer): gp_Pnt2d;
  /** Sets an UV-node coordinates. theIndex node index within [1, NbNodes()] range thePnt UV coordinates */
  SetUVNode(theIndex: Standard_Integer, thePnt: gp_Pnt2d): void;
  /** Returns triangle at the given index. theIndex triangle index within [1, NbTriangles()] range triangle node indices, with each node defined within [1, NbNodes()] range */
  Triangle(theIndex: Standard_Integer): Poly_Triangle;
  /** Sets a triangle. theIndex triangle index within [1, NbTriangles()] range theTriangle triangle node indices, with each node defined within [1, NbNodes()] range */
  SetTriangle(theIndex: Standard_Integer, theTriangle: Poly_Triangle): void;
  /** Returns normal at the given index. theIndex node index within [1, NbNodes()] range normalized 3D vector defining a surface normal */
  Normal_1(theIndex: Standard_Integer): gp_Dir;
  /** Returns normal at the given index. theIndex node index within [1, NbNodes()] range normalized 3D vector defining a surface normal */
  Normal_2(theIndex: Standard_Integer, theVec3: NCollection_Vec3<float>): void;
  /** Changes normal at the given index. theIndex node index within [1, NbNodes()] range theVec3 normalized 3D vector defining a surface normal */
  ...
  /** Extends the passed box with bounding box of this triangulation. Uses cached min - max range when available and: input transformation theTrsf has no rotation part; theIsAccurate is set to FALSE; no triangulation data available (e.g. it is deferred and not loaded). out] theBox bounding box to extend by this triangulation theTrsf optional transformation theIsAccurate when FALSE, allows using a cached min - max range of this triangulation even for non-identity transformation. FALSE if there is no any data to extend the passed box (no both triangulation and cached min - max range). */
  ...
  /** Method resizing internal arrays of nodes (synchronously for all attributes). theNbNodes new number of nodes theToCopyOld copy old nodes into the new array */
  ResizeNodes(theNbNodes: Standard_Integer, theToCopyOld: Standard_Boolean): void;
  /** Method resizing an internal array of triangles. theNbTriangles new number of triangles theToCopyOld copy old triangles into the new array */
...
export declare class TopLoc_Location {
  ...
  /** Returns a hashed value for this local coordinate system. This value is used, with map tables, to store and retrieve the object easily a computed hash code */
...
export declare class gp_Dir {
  ...
  /** Assigns the given value to the X coordinate of this unit vector. Constexpr-compatible when result is already normalized. */
  SetX(theX: Standard_Real): void;
  /** Assigns the given value to the Y coordinate of this unit vector. Constexpr-compatible when result is already normalized. */
  SetY(theY: Standard_Real): void;
  /** Assigns the given value to the Z coordinate of this unit vector. Constexpr-compatible when result is already normalized. */
  SetZ(theZ: Standard_Real): void;
  /** Assigns the three coordinates of theCoord to this unit vector. Constexpr-compatible when input is already normalized. */
  ...
  /** Returns the coordinate of range theIndex : theIndex = 1 => X is returned theIndex = 2 => Y is returned theIndex = 3 => Z is returned Exceptions Standard_OutOfRange if theIndex is not 1, 2, or 3. */
  Coord_2(): { theXv: number; theYv: number; theZv: number };
  ...
  /** Computes the cross product between two directions Raises the exception ConstructionError if the two directions are parallel because the computed vector cannot be normalized to create a direction. Constexpr-compatible when result is already normalized. */
  Cross(theRight: gp_Dir): void;
  /** Computes the triple vector product. <me> ^ (V1 ^ V2) Raises the exception ConstructionError if V1 and V2 are parallel or <me> and (V1^V2) are parallel because the computed vector can't be normalized to create a direction. Constexpr-compatible when result is already normalized. */
...
export declare class gp_Dir2d {
  ...
  Coord_1(theIndex: Standard_Integer): Standard_Real;
  /** For this unit vector returns the coordinate of range theIndex : theIndex = 1 => X is returned theIndex = 2 => Y is returned Raises OutOfRange if theIndex != {1, 2}. */
  Coord_2(): { theXv: number; theYv: number };
...
export declare type gp_Dir2d_DValue = 'X' | 'Y' | 'NX' | 'NY';
...
export declare class gp_GTrsf {
  ...
  Inverted(): gp_GTrsf;
  /** Computes the transformation composed from theT and <me>. In a C++ implementation you can also write Tcomposed = <me> * theT. Example : gp_GTrsfT1,T2,Tcomp;............... //composition: Tcomp=T2.Multiplied(T1);//or(Tcomp=T2*T1) //transformationofapoint gp_XYZP(10.,3.,4.); gp_XYZP1(P); Tcomp.Transforms(P1);//usingTcomp gp_XYZP2(P); T1.Transforms(P2);//usingT1thenT2 T2.Transforms(P2);//P1=P2!!! */
  ...
  Transforms_2(): { theX: number; theY: number; theZ: number };
  Trsf(): gp_Trsf;
  delete(): void;
  [Symbol.dispose](): void;
}
...
export declare class gp_GTrsf2d {
  ...
  Inverted(): gp_GTrsf2d;
  /** Computes the transformation composed with theT and <me>. In a C++ implementation you can also write Tcomposed = <me> * theT. Example : gp_GTrsf2dT1,T2,Tcomp;............... //composition: Tcomp=T2.Multiplied(T1);//or(Tcomp=T2*T1) //transformationofapoint gp_XYP(10.,3.); gp_XYP1(P); Tcomp.Transforms(P1);//usingTcomp gp_XYP2(P); T1.Transforms(P2);//usingT1thenT2 T2.Transforms(P2);//P1=P2!!! */
  ...
  Transforms_2(): { theX: number; theY: number };
...
export declare class gp_Pln {
  ...
  Coefficients(): { theA: number; theB: number; theC: number; theD: number };
  ...
  /** Computes the signed distance between <me> and the point <theP>. The sign of the distance indicates on which side of the plane the point is located: positive sign: the point is located in the direction of the plane normal, negative sign: the point is located in the opposite direction to the plane normal, zero: the point is located on the plane. */
...
export declare class gp_Trsf {
  ...
  GetRotation_1(theAxis: gp_XYZ): { result: Standard_Boolean; theAngle: number };
  /** Returns the boolean True if there is non-zero rotation. In the presence of rotation, the output parameters store the axis and the angle of rotation. The method always returns positive value "theAngle", i.e., 0. < theAngle <= PI. Note that this rotation is defined only by the vectorial part of the transformation; generally you would need to check also the translational part to obtain the axis (gp_Ax1) of rotation. */
  ...
  Value(theRow: Standard_Integer, theCol: Standard_Integer): Standard_Real;
  Invert(): void;
  /** Computes the reverse transformation Raises an exception if the matrix of the transformation is not inversible, it means that the scale factor is lower or equal to Resolution from package gp. Computes the transformation composed with T and <me>. In a C++ implementation you can also write Tcomposed = <me> * T. Example : gp_TrsfT1,T2,Tcomp;............... Tcomp=T2.Multiplied(T1);//or(Tcomp=T2*T1) gp_PntP1(10.,3.,4.); gp_PntP2=P1.Transformed(Tcomp);//usingTcomp gp_PntP3=P1.Transformed(T1);//usingT1thenT2 P3.Transform(T2);//P3=P2!!! */
  Inverted(): gp_Trsf;
  ...
  Transforms_1(): { theX: number; theY: number; theZ: number };
...
export declare class gp_Trsf2d {
  ...
  Transforms_1(): { theX: number; theY: number };
...
export declare class gp_XY {
  ...
  /** returns the coordinate of range theIndex : theIndex = 1 => X is returned theIndex = 2 => Y is returned Raises OutOfRange if theIndex != {1, 2}. */
  Coord_2(): { theX: number; theY: number };
  ...
  Normalized(): gp_XY;
  Reverse(): void;
  /** <me>.X()=-<me>.X() <me>.Y()=-<me>.Y() constexprvoidReverse()noexcept { x=-x; y=-y; } @code New.X()=-<me>.X() New.Y()=-<me>.Y() */
  Reversed(): gp_XY;
...
export declare class gp_XYZ {
  ...
  ChangeCoord(theIndex: Standard_Integer): Standard_Real;
  /** returns the coordinate of range theIndex : theIndex = 1 => X is returned theIndex = 2 => Y is returned theIndex = 3 => Z is returned Raises OutOfRange if theIndex != {1, 2, 3}. */
  Coord_2(): { theX: number; theY: number; theZ: number };
...
export declare class Quantity_ColorRGBA {
  ...
  /** Finds color from predefined names. For example, the name of the color which corresponds to "BLACK" is Quantity_NOC_BLACK. An alpha component is set to 1.0. theColorNameString the color name theColor a found color false if the color name is unknown, or true if the search by color name was successful */
  static ColorFromName(theColorNameString: Standard_Character, theColor: Quantity_ColorRGBA): Standard_Boolean;
  /** Parses the string as a hex color (like "#FF0" for short sRGB color, "#FF0F" for short sRGBA color, "#FFFF00" for RGB color, or "#FFFF00FF" for RGBA color) theHexColorString the string to be parsed theColor a color that is a result of parsing theAlphaComponentIsOff the flag that indicates if a color alpha component is presented in the input string (false) or not (true) true if parsing was successful, or false otherwise */
...
export declare class TCollection_ExtendedString {
  /** Appends the other extended string to this extended string. Note that this method is an alias of operator +=. Example: TCollection_ExtendedStringaString(u"Hello"); TCollection_ExtendedStringanotherString(u"World"); aString+=anotherString; //Result:aString==u"HelloWorld" theOther the string to append */
  ...
  /** Core implementation: Concatenates char16_t string (pointer and length) and returns a new string. theOther pointer to the string to append theLength length of the string to append new string with theOther appended */
  ...
  /** Substitutes all the characters equal to theChar by theNewChar in this ExtendedString. The substitution can be case sensitive. If you don't use default case sensitive, no matter whether theChar is uppercase or not. Example: TCollection_ExtendedStringaString(u"Histake"); aString.ChangeAll(u'H',u'M'); //Result:aString==u"Mistake" theChar the character to replace theNewChar the replacement character */
  ...
  Clear(): void;
  /** Core implementation: Copy from a char16_t pointer with explicit length. theString pointer to the string to copy theLength length of the string to copy */
  ...
  /** Moves string without reallocations. theOther the string to move from */
  Move(theOther: TCollection_ExtendedString): void;
  /** Exchange the data of two strings (without reallocating memory). theOther the string to exchange data with */
  Swap(theOther: TCollection_ExtendedString): void;
  /** Insert a Character at position theWhere. Example: TCollection_ExtendedStringaString(u"hynot?"); aString.Insert(1,u'W'); //Result:aString==u"Whynot?" theWhere the position to insert at (1-based) theWhat the character to insert */
  ...
  IsEmpty(): Standard_Boolean;
  /** Core implementation: Returns true if this string equals theOther (pointer and length). theOther pointer to the string to compare with theLength length of the string to compare with true if strings are equal, false otherwise */
  ...
  /** Core implementation: Returns true if this string differs from theOther (pointer and length). theOther pointer to the string to compare with theLength length of the string to compare with true if strings are different, false otherwise */
  ...
  /** Core implementation: Returns TRUE if this string is lexicographically less than theOther. theOther pointer to the string to compare with theLength length of the string to compare with true if this string is less than theOther */
  ...
  /** Core implementation: Returns TRUE if this string is lexicographically greater than theOther. theOther pointer to the string to compare with theLength length of the string to compare with true if this string is greater than theOther */
  ...
  /** Core implementation: Determines whether this string starts with theStartString. theStartString pointer to the string to check for theLength length of the string to check for true if this string starts with theStartString */
  ...
  /** Core implementation: Determines whether this string ends with theEndString. theEndString pointer to the string to check for theLength length of the string to check for true if this string ends with theEndString */
  ...
  /** Returns True if the ExtendedString contains only "Ascii Range" characters. true if string contains only ASCII characters */
  IsAscii(): Standard_Boolean;
  /** Returns the number of 16-bit code units (might be greater than number of Unicode symbols if string contains surrogate pairs). the number of 16-bit code units */
  Length(): Standard_Integer;
  /** Removes every theWhat characters from this string. theWhat the character to remove */
  RemoveAll(theWhat: Standard_ExtCharacter): void;
  /** Erases theHowMany characters from position theWhere, theWhere included. Example: TCollection_ExtendedStringaString(u"Hello"); aString.Remove(2,2);//erases2charactersfromposition2 //Result:aString==u"Hlo" theWhere the position to start erasing from (1-based) theHowMany the number of characters to erase */
  Remove(theWhere: Standard_Integer, theHowMany: Standard_Integer): void;
  /** Core implementation: Searches for theWhat (pointer and length) from the beginning. theWhat pointer to the string to search for theLength length of the string to search for the position of first match (1-based), or -1 if not found */
  ...
  /** Core implementation: Searches for theWhat (pointer and length) from the end. theWhat pointer to the string to search for theLength length of the string to search for the position of first match from end (1-based), or -1 if not found */
  ...
  /** Replaces one character in the ExtendedString at position theWhere. If theWhere is less than zero or greater than the length of this string an exception is raised. Example: TCollection_ExtendedStringaString(u"Garbake"); aString.SetValue(6,u'g'); //Result:aString==u"Garbage" theWhere the position to replace at (1-based) theWhat the character to replace with */
  ...
  /** Returns expected CString length in UTF8 coding (like strlen, without null terminator). It can be used for memory calculation before converting to CString containing symbols in UTF8 coding. For external allocation, use: char* buf = new char[str.LengthOfCString() + 1]; expected UTF-8 string length */
  ...
  RightAdjust(): void;
  /** Left justify. Length becomes equal to theWidth and the new characters are equal to theFiller. If theWidth < Length nothing happens. theWidth the desired width of the string theFiller the character to fill with */
  LeftJustify(theWidth: Standard_Integer, theFiller: Standard_ExtCharacter): void;
  /** Right justify. Length becomes equal to theWidth and the new characters are equal to theFiller. If theWidth < Length nothing happens. theWidth the desired width of the string theFiller the character to fill with */
  RightJustify(theWidth: Standard_Integer, theFiller: Standard_ExtCharacter): void;
  /** Modifies this string so that its length becomes equal to theWidth and the new characters are equal to theFiller. New characters are added both at the beginning and at the end of this string. If theWidth is less than the length of this string, nothing happens. theWidth the desired width of the string theFiller the character to fill with */
  Center(theWidth: Standard_Integer, theFiller: Standard_ExtCharacter): void;
  /** Converts the first character into its corresponding upper-case character and the other characters into lowercase. Only ASCII characters (a-z, A-Z) are affected by case conversion. */
  Capitalize(): void;
  /** Core implementation: Inserts char16_t string (pointer and length) at the beginning. theOther pointer to the string to prepend theLength length of the string to prepend */
  ...
  /** Returns the index of the first character of this string that is present in theSet. The search begins at index theFromIndex and ends at index theToIndex. Returns zero if failure. theSet the set of characters to search for theFromIndex the starting index for search (1-based) theToIndex the ending index for search (1-based) the index of first character found in set, or 0 if not found */
  ...
  /** Returns the index of the first character of this string that is NOT present in theSet. The search begins at index theFromIndex and ends at index theToIndex. Returns zero if failure. theSet the set of characters to check against theFromIndex the starting index for search (1-based) theToIndex the ending index for search (1-based) the index of first character not in set, or 0 if not found */
  ...
  /** Converts this extended string containing a numeric expression to an Integer. the integer value */
  IntegerValue(): Standard_Integer;
  /** Returns True if this extended string contains an integer value. true if string represents an integer value */
  IsIntegerValue(): Standard_Boolean;
  /** Converts this extended string containing a numeric expression to a Real. the real value */
  RealValue(): Standard_Real;
  /** Returns True if this extended string starts with characters that can be interpreted as a real value. theToCheckFull when TRUE, checks if entire string defines a real value; otherwise checks if string starts with a real value true if string represents a real value */
  IsRealValue(theToCheckFull: Standard_Boolean): Standard_Boolean;
  /** Returns True if the strings contain same characters. theOther the string to compare with theIsCaseSensitive flag indicating case sensitivity When case-insensitive, only ASCII characters (a-z, A-Z) are affected. true if strings contain same characters */
...
export declare type BOPAlgo_GlueEnum = {
  BOPAlgo_GlueOff: BOPAlgo_GlueEnumValue;
  BOPAlgo_GlueShift: BOPAlgo_GlueEnumValue;
  BOPAlgo_GlueFull: BOPAlgo_GlueEnumValue;
}

export declare type BOPAlgo_GlueEnumValue = 'BOPAlgo_GlueOff' | 'BOPAlgo_GlueShift' | 'BOPAlgo_GlueFull';
...
export declare type BRepFill_TypeOfContact = {
  BRepFill_NoContact: BRepFill_TypeOfContactValue;
  BRepFill_Contact: BRepFill_TypeOfContactValue;
  BRepFill_ContactOnBorder: BRepFill_TypeOfContactValue;
}

export declare type BRepFill_TypeOfContactValue = 'BRepFill_NoContact' | 'BRepFill_Contact' | 'BRepFill_ContactOnBorder';
...
export declare class BRepFilletAPI_MakeChamfer extends BRepFilletAPI_LocalOperation {
  ...
  GetDist(IC: Standard_Integer): { Dis: number };
  /** Adds edge E to the table of edges used by this algorithm to build chamfers, where the parameters of the chamfer must be set after the */
  ...
  Dists(IC: Standard_Integer): { Dis1: number; Dis2: number };
  ...
  GetDistAngle(IC: Standard_Integer): { Dis: number; Angle: number };
...
export declare class BRepFilletAPI_MakeFillet extends BRepFilletAPI_LocalOperation {
  ...
  GetBounds(IC: Standard_Integer, E: TopoDS_Edge): { result: Standard_Boolean; F: number; L: number };
...
export declare type ChFi3d_FilletShape = {
  ChFi3d_Rational: ChFi3d_FilletShapeValue;
  ChFi3d_QuasiAngular: ChFi3d_FilletShapeValue;
  ChFi3d_Polynomial: ChFi3d_FilletShapeValue;
}

export declare type ChFi3d_FilletShapeValue = 'ChFi3d_Rational' | 'ChFi3d_QuasiAngular' | 'ChFi3d_Polynomial';

export declare type ChFiDS_ChamfMode = {
  ChFiDS_ClassicChamfer: ChFiDS_ChamfModeValue;
  ChFiDS_ConstThroatChamfer: ChFiDS_ChamfModeValue;
  ChFiDS_ConstThroatWithPenetrationChamfer: ChFiDS_ChamfModeValue;
}

export declare type ChFiDS_ChamfModeValue = 'ChFiDS_ClassicChamfer' | 'ChFiDS_ConstThroatChamfer' | 'ChFiDS_ConstThroatWithPenetrationChamfer';
...
export declare class Geom2dAPI_ExtremaCurveCurve {
  ...
  Parameters(Index: Standard_Integer): { U1: number; U2: number };
...
export declare class Geom2dAPI_ProjectPointOnCurve {
  /** Initializes this algorithm with the given arguments, and computes the orthogonal projections of a point on a curve <Curve> */
  ...
  /** Returns the parameter on the curve of a point which is the orthogonal projection. Index is a number of a computed projected point. Exceptions Standard_OutOfRange if Index is not in the range [ 1,NbPoints ], where NbPoints is the number of solution points. */
  Parameter_2(Index: Standard_Integer): { U: number };
...
export declare class GeomAPI_ProjectPointOnSurf {
  ...
  Parameters(Index: Standard_Integer): { U: number; V: number };
...
export declare class Law_BSpFunc extends Law_Function {
  ...
  D1(X: Standard_Real): { F: number; D: number };
  /** Returns the value, first and second derivatives at parameter X. */
  D2(X: Standard_Real): { F: number; D: number; D2: number };
...
export declare class HLRAlgo_Projector {
  ...
  /** Transform and apply perspective if needed. */
  Project_2(P: gp_Pnt): { X: number; Y: number; Z: number };
  /** Transform and apply perspective if needed. */
...
export declare type BRepOffset_Mode = {
  BRepOffset_Skin: BRepOffset_ModeValue;
  BRepOffset_Pipe: BRepOffset_ModeValue;
  BRepOffset_RectoVerso: BRepOffset_ModeValue;
}

export declare type BRepOffset_ModeValue = 'BRepOffset_Skin' | 'BRepOffset_Pipe' | 'BRepOffset_RectoVerso';
...
export declare type BRepBuilderAPI_TransitionMode = {
  BRepBuilderAPI_Transformed: BRepBuilderAPI_TransitionModeValue;
  BRepBuilderAPI_RightCorner: BRepBuilderAPI_TransitionModeValue;
  BRepBuilderAPI_RoundCorner: BRepBuilderAPI_TransitionModeValue;
}

export declare type BRepBuilderAPI_TransitionModeValue = 'BRepBuilderAPI_Transformed' | 'BRepBuilderAPI_RightCorner' | 'BRepBuilderAPI_RoundCorner';

export declare type BRepBuilderAPI_WireError = {
  BRepBuilderAPI_WireDone: BRepBuilderAPI_WireErrorValue;
  BRepBuilderAPI_EmptyWire: BRepBuilderAPI_WireErrorValue;
  BRepBuilderAPI_DisconnectedWire: BRepBuilderAPI_WireErrorValue;
  BRepBuilderAPI_NonManifoldWire: BRepBuilderAPI_WireErrorValue;
}

export declare type BRepBuilderAPI_WireErrorValue = 'BRepBuilderAPI_WireDone' | 'BRepBuilderAPI_EmptyWire' | 'BRepBuilderAPI_DisconnectedWire' | 'BRepBuilderAPI_NonManifoldWire';
...
export declare class BRepAdaptor_CompCurve extends Adaptor3d_Curve {
  ...
  Edge(U: Standard_Real, E: TopoDS_Edge): { UonE: number };
  FirstParameter(): Standard_Real;
  LastParameter(): Standard_Real;
  Continuity(): GeomAbs_Shape;
  /** Returns the number of intervals for continuity . May be one if Continuity(me) >= */
...
export declare class BinTools {
  constructor();
  /** Writes the shape to the stream in binary format BinTools_FormatVersion_CURRENT. This alias writes shape with triangulation data. theShape the shape to write out] theStream the stream to output shape into theRange the range of progress indicator to fill in */
...
export declare class TopoDS_Shape {
  ...
  /** Returns a shape similar to <me> with the local coordinate system set to <Loc>. theLoc the new local coordinate system. theRaiseExc flag to raise exception in case of transformation with scale or negative. the located shape. */
  ...
  /** Multiplies the Shape location by thePosition. thePosition the transformation to apply. theRaiseExc flag to raise exception in case of transformation with scale or negative. */
  Move(thePosition: TopLoc_Location, theRaiseExc: Standard_Boolean): void;
  /** Returns a shape similar to <me> with a location multiplied by thePosition. thePosition the transformation to apply. theRaiseExc flag to raise exception in case of transformation with scale or negative. the moved shape. */
  ...
  /** Returns the number of direct sub-shapes (children). TopoDS_Iterator for accessing sub-shapes */
  NbChildren(): Standard_Integer;
...
export declare class Geom2d_BSplineCurve extends Geom2d_BoundedCurve {
  ...
  /** Inserts a knot value in the sequence of knots. If is an existing knot the multiplicity is increased by <M>. If U is not on the parameter range nothing is done. If the multiplicity is negative or null nothing is done. The new multiplicity is limited to the degree. The tolerance criterion for knots equality is the max of Epsilon(U) and ParametricTolerance. Warning If U is less than the first parameter or greater than the last parameter of this BSpline curve, nothing is done. If M is negative or null, nothing is done. The multiplicity of a knot is limited to the degree of this BSpline curve. */
  ...
  MovePoint(U: Standard_Real, P: gp_Pnt2d, Index1: Standard_Integer, Index2: Standard_Integer): { FirstModifiedPole: number; LastModifiedPole: number };
  ...
  MovePointAndTangent(U: Standard_Real, P: gp_Pnt2d, Tangent: gp_Vec2d, Tolerance: Standard_Real, StartingCondition: Standard_Integer, EndingCondition: Standard_Integer): { ErrorStatus: number };
  ...
  LocateU(U: Standard_Real, ParametricTolerance: Standard_Real, WithKnotRepetition: Standard_Boolean): { I1: number; I2: number };
  ...
  /** Returns a const reference to the weights array. For rational curves: the internal owning weights array. For non-rational curves: a non-owning view of unit weights from BSplCLib. The array is always sized to match NbPoles(). Do NOT modify elements through the returned reference. */
  ...
  Resolution(ToleranceUV: Standard_Real): { UTolerance: number };
...
export declare class Geom_BSplineCurve extends Geom_BoundedCurve {
  ...
  IncrementMultiplicity(I1: Standard_Integer, I2: Standard_Integer, M: Standard_Integer): void;
  /** Inserts a knot value in the sequence of knots. If is an existing knot the multiplicity is increased by <M>. If U is not on the parameter range nothing is done. If the multiplicity is negative or null nothing is done. The new multiplicity is limited to the degree. The tolerance criterion for knots equality is the max of Epsilon(U) and ParametricTolerance. */
  InsertKnot(U: Standard_Real, M: Standard_Integer, ParametricTolerance: Standard_Real, Add: Standard_Boolean): void;
  /** Inserts a set of knots values in the sequence of knots. For each U = Knots(i), M = Mults(i) If is an existing knot the multiplicity is increased by <M> if <Add> is True, increased to <M> if <Add> is False. If U is not on the parameter range nothing is done. If the multiplicity is negative or null nothing is done. The new multiplicity is limited to the degree. The tolerance criterion for knots equality is the max of Epsilon(U) and ParametricTolerance. */
  InsertKnots(Knots: TColStd_Array1OfReal, Mults: TColStd_Array1OfInteger, ParametricTolerance: Standard_Real, Add: Standard_Boolean): void;
  ...
  SetWeight(Index: Standard_Integer, Weight: Standard_Real): void;
  /** Moves the point of parameter U of this BSpline curve to P. Index1 and Index2 are the indexes in the table of poles of this BSpline curve of the first and last poles designated to be moved. FirstModifiedPole and LastModifiedPole are the indexes of the first and last poles which are effectively modified. In the event of incompatibility between Index1, Index2 and the value U: no change is made to this BSpline curve, and the FirstModifiedPole and LastModifiedPole are returned null. Exceptions Standard_OutOfRange if: Index1 is greater than or equal to Index2, or Index1 or Index2 is less than 1 or greater than the number of poles of this BSpline curve. */
  MovePoint(U: Standard_Real, P: gp_Pnt, Index1: Standard_Integer, Index2: Standard_Integer): { FirstModifiedPole: number; LastModifiedPole: number };
  /** Move a point with parameter U to P. and makes it tangent at U be Tangent. StartingCondition = -1 means first can move EndingCondition = -1 means last point can move StartingCondition = 0 means the first point cannot move EndingCondition = 0 means the last point cannot move StartingCondition = 1 means the first point and tangent cannot move EndingCondition = 1 means the last point and tangent cannot move and so forth ErrorStatus != 0 means that there are not enough degree of freedom with the constrain to deform the curve accordingly */
  MovePointAndTangent(U: Standard_Real, P: gp_Pnt, Tangent: gp_Vec, Tolerance: Standard_Real, StartingCondition: Standard_Integer, EndingCondition: Standard_Integer): { ErrorStatus: number };
  ...
  Resolution(Tolerance3D: Standard_Real): { UTolerance: number };
  /** Creates a new object which is a copy of this BSpline curve. */
  Copy(): any;
...
export declare class Geom_BSplineSurface extends Geom_BoundedSurface {
  ...
  LocateV(V: Standard_Real, ParametricTolerance: Standard_Real, WithKnotRepetition: Standard_Boolean): { I1: number; I2: number };
  ...
  MovePoint(U: Standard_Real, V: Standard_Real, P: gp_Pnt, UIndex1: Standard_Integer, UIndex2: Standard_Integer, VIndex1: Standard_Integer, VIndex2: Standard_Integer): { UFirstIndex: number; ULastIndex: number; VFirstIndex: number; VLastIndex: number };
  ...
  /** Returns a const reference to the weights array. For rational surfaces: the internal owning weights array. For non-rational surfaces: a non-owning view of unit weights from BSplSLib. The array is always sized to match NbUPoles() x NbVPoles(). Do NOT modify elements through the returned reference. */
  ...
  Resolution(Tolerance3D: Standard_Real): { UTolerance: number; VTolerance: number };
...
export declare class Geom_ConicalSurface extends Geom_ElementarySurface {
  ...
  VReverse(): void;
  /** Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are the new values of U,V after calling me->TransformParameters(U,V,T) This method multiplies V by T.ScaleFactor() */
  TransformParameters(T: gp_Trsf): { U: number; V: number };
  /** Returns a 2d transformation used to find the new parameters of a point on the transformed surface. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are obtained by transforming U,V with the 2d transformation returned by me->ParametricTransformation(T) This method returns a scale centered on the U axis with T.ScaleFactor */
...
export declare class Geom_Curve extends Geom_Geometry {
  ...
  ReversedParameter(U: Standard_Real): Standard_Real;
  /** Returns the parameter on the transformed curve for the transform of the point of parameter U on <me>. me->Transformed(T)->Value(me->TransformedParameter(U,T)) is the same point as me->Value(U).Transformed(T) This methods returns It can be redefined. For example on the Line. */
...
export declare class Geom_Surface extends Geom_Geometry {
  ...
  VReversedParameter(V: Standard_Real): Standard_Real;
  /** Computes the parameters on the transformed surface for the transform of the point of parameters U,V on <me>. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are the new values of U,V after calling me->TransformParameters(U,V,T) This method does not change and <V> It can be redefined. For example on the Plane, Cylinder, Cone, Revolved and Extruded surfaces. */
  TransformParameters(T: gp_Trsf): { U: number; V: number };
  /** Returns a 2d transformation used to find the new parameters of a point on the transformed surface. me->Transformed(T)->Value(U',V') is the same point as me->Value(U,V).Transformed(T) Where U',V' are obtained by transforming U,V with the 2d transformation returned by me->ParametricTransformation(T) This method returns an identity transformation It can be redefined. For example on the Plane, Cylinder, Cone, Revolved and Extruded surfaces. */
  ParametricTransformation(T: gp_Trsf): gp_GTrsf2d;
...
export declare class GeomAdaptor_TransformedSurface extends Adaptor3d_Surface {
  ...
  /** Shallow copy of adaptor. */
  ShallowCopy(): any;
  /** Loads the surface geometry. theSurface underlying geometry */
  ...
  /** Sets the transformation. theTrsf transformation to apply */
...
export declare type TopAbs_Orientation = {
  TopAbs_FORWARD: TopAbs_OrientationValue;
  TopAbs_REVERSED: TopAbs_OrientationValue;
  TopAbs_INTERNAL: TopAbs_OrientationValue;
  TopAbs_EXTERNAL: TopAbs_OrientationValue;
}

export declare type TopAbs_OrientationValue = 'TopAbs_FORWARD' | 'TopAbs_REVERSED' | 'TopAbs_INTERNAL' | 'TopAbs_EXTERNAL';

export declare type TopAbs_ShapeEnum = {
  TopAbs_COMPOUND: TopAbs_ShapeEnumValue;
  TopAbs_COMPSOLID: TopAbs_ShapeEnumValue;
  TopAbs_SOLID: TopAbs_ShapeEnumValue;
  TopAbs_SHELL: TopAbs_ShapeEnumValue;
  TopAbs_FACE: TopAbs_ShapeEnumValue;
  TopAbs_WIRE: TopAbs_ShapeEnumValue;
  TopAbs_EDGE: TopAbs_ShapeEnumValue;
  TopAbs_VERTEX: TopAbs_ShapeEnumValue;
  TopAbs_SHAPE: TopAbs_ShapeEnumValue;
}

export declare type TopAbs_ShapeEnumValue = 'TopAbs_COMPOUND' | 'TopAbs_COMPSOLID' | 'TopAbs_SOLID' | 'TopAbs_SHELL' | 'TopAbs_FACE' | 'TopAbs_WIRE' | 'TopAbs_EDGE' | 'TopAbs_VERTEX' | 'TopAbs_SHAPE';
...
export declare type Extrema_ExtAlgo = {
  Extrema_ExtAlgo_Grad: Extrema_ExtAlgoValue;
  Extrema_ExtAlgo_Tree: Extrema_ExtAlgoValue;
}

export declare type Extrema_ExtAlgoValue = 'Extrema_ExtAlgo_Grad' | 'Extrema_ExtAlgo_Tree';
...
export declare class GCPnts_TangentialDeflection {
  /** Initialize algorithm for 3D curve. theC 3d curve theAngularDeflection angular deflection in radians theCurvatureDeflection linear deflection theMinimumOfPoints minimum number of points theUTol tolerance in curve parametric scope theMinLen minimal length */
...
export declare class BooleanPipeline {
  constructor();
  addStep(opCode: Standard_Integer, tool: TopoDS_Shape): void;
  execute(base: TopoDS_Shape, glueMode: Standard_Integer, fuzzyValue: Standard_Real): TopoDS_Shape;
  stepCount(): Standard_Integer;
  clear(): void;
  delete(): void;
  [Symbol.dispose](): void;
}
...
export declare class Curve2dBatchEval {
  constructor();
  static evaluate(curve: Handle_Geom2d_Curve, params: Standard_Real, paramCount: Standard_Integer, outPtr: Standard_Real): Standard_Integer;
  static evaluateD1(curve: Handle_Geom2d_Curve, params: Standard_Real, paramCount: Standard_Integer, outPtr: Standard_Real): Standard_Integer;
  delete(): void;
  [Symbol.dispose](): void;
}

export declare class SpatialIndex3D {
  constructor()
  addPoint(x: Standard_Real, y: Standard_Real, z: Standard_Real): void;
  build(): void;
  nearestPoint(x: Standard_Real, y: Standard_Real, z: Standard_Real): Standard_Integer;
  pointsInRadius(x: Standard_Real, y: Standard_Real, z: Standard_Real, radius: Standard_Real, outPtr: Standard_Integer, maxResults: Standard_Integer): Standard_Integer;
  size(): Standard_Integer;
  delete(): void;
  [Symbol.dispose](): void;
}

export declare class MeshBatchData {
  constructor();
  getOffsetsPtr(): Standard_Integer;
  getOffsetsSize(): Standard_Integer;
  getVerticesPtr(): Standard_Integer;
  getVerticesSize(): Standard_Integer;
  getNormalsPtr(): Standard_Integer;
  getNormalsSize(): Standard_Integer;
  getTrianglesPtr(): Standard_Integer;
  getTrianglesSize(): Standard_Integer;
  getShapeCount(): Standard_Integer;
  dispose(): void;
  delete(): void;
  [Symbol.dispose](): void;
}

export declare class MeshBatchExtractor {
  constructor();
  addShape(shape: TopoDS_Shape): void;
  extract(tolerance: Standard_Real, angularTolerance: Standard_Real): MeshBatchData;
  delete(): void;
  [Symbol.dispose](): void;
}
...
export type OpenCascadeInstance = {FS: typeof FS} & {
  ...
  BooleanPipeline: typeof BooleanPipeline;
  ...
  StepStreamIO: typeof StepStreamIO;
  Curve2dBatchEval: typeof Curve2dBatchEval;
  SpatialIndex3D: typeof SpatialIndex3D;
  MeshBatchData: typeof MeshBatchData;
  MeshBatchExtractor: typeof MeshBatchExtractor;
